...
echo "Getting common go packages (goa, gorma, etc..) - this may take a while..."
...
go get -u github.com/cboecking/gorma-sample/...
go get -u github.com/cboecking/golang-env-setup/...
go get -u github.com/cboecking/goa-design-base/...
